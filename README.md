...
- Fehler-Codes zusätzlich zu Auth: `forbidden`, `not_found`, `invite_invalid`, `banned`. Feld-Codes wie bisher; neue Felder: `kind`, `category_id`, `member_permissions`, `max_uses`, `expires_in_hours`, `content`, `before`, `after`, `limit`, `user_id`.
